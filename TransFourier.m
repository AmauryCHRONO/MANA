...
% Input: 
% - s: vecteur de taille N contenant les N échantillons s[n] du signal à
% analyser
% - t: vecteur de taille N contenant les instants d'echantillonnage de s.
% s[n] = s(t[n]).
% Outputs:
% - S : vecteur de taille N contenant les coeffeciens de la transformée de
% Fourier du signal s
% - f : vecteur de taille N contenant les fréquences correspondant aux
